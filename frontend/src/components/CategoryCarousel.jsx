...
const CategoryCarousel = () => {
    ...
    return (
        <div>
            <Carousel className="w-full max-w-xl mx-auto my-5 max-sm:px-5 max-sm:w-full max-sm:max-w-[65%]">
                <CarouselContent>
                    {
                        category.map((cat, index) => (
                            <CarouselItem className="md:basis-1/3 lg:basis-1/3 max-sm:basis-1/1">
